...
@Component({
  selector: 'app-user-edit-transaction-room-list-page',
  templateUrl: './user-edit-transaction-room-list-page.component.html',
  styleUrls: ['./user-edit-transaction-room-list-page.component.scss'],
  providers: [DataServiceTransaction]
})
export class UserEditTransactionRoomListPageComponent implements OnInit {

...
namespace Hotel.Migrations
{
    ...
    [Migration("20190713101100_AddIniitBase_1")]
    partial class AddIniitBase_1
    {
            ...
            modelBuilder.Entity("Hotel.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TransactionID = 1,
                            CheckInTime = new DateTime(2019, 7, 13, 13, 10, 57, 830, DateTimeKind.Local).AddTicks(8338),
                            CheckOutTime = new DateTime(2019, 7, 14, 13, 10, 57, 840, DateTimeKind.Local).AddTicks(6386),
                            Cost = 3500,
                            IsPaid = true,
                            RoomId = 1,
                            UserId = 3
